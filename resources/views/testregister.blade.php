            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('login') }}" role="form" class="text-start">
                  ...
                  <div class="input-group input-group-outline mb-2 my-3">
                    <label class="form-label">Password-confirm</label>
                    <input type="password-confirm" class="form-control @error('password-confirm') is-invalid @enderror" name="password_confirmation">
                  ...
                  <div class="form-check form-switch d-flex align-items-center mb-3 my-3">
                  ...
                  <p class="mt-4 text-sm text-center">
                    ...
                    <a href="{{ route('password.request') }}" class="text-primary text-gradient font-weight-bold">{{ __('register') }}</a>
                  </p>
                </form>
              </div>
            </div>
